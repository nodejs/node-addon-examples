...
void Add(const Nan::FunctionCallbackInfo<v8::Value>& info) {
  ...
  MyObject* obj1 = Nan::ObjectWrap::Unwrap<MyObject>(info[0]->ToObject(context).ToLocalChecked());
  MyObject* obj2 = Nan::ObjectWrap::Unwrap<MyObject>(info[1]->ToObject(context).ToLocalChecked());
