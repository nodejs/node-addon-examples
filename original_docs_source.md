*This is the original document from the [joyent/node](https://github.com/joyent/node) repository as docs/api/addons.markdown. This documentation was used as a foundation for some of the documentation and code found in the [node-addon-examples](https://github.com/rvagg/node-addon-examples) repository.*
